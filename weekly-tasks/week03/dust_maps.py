...
#SD 100 steps of 0.1 deg is 10 deg total range
...
#SD 100 steps of 0.13 deg is 13 deg total range
#SD Therefore go 6.5 below and 6.5 above of RA value for lower and upper bounds
#SD for DEC do same range as for dec1
...
#SD find reddening for grid1 and grid2
